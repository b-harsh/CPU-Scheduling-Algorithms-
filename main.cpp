...
// In timeline Array
// '*' : This character indicates that the process is being executed at that time unit.
// '.' : This character indicates that the process is waiting at that time unit.
...
void shortestProcessNext() /////NOn Pre Emptive Version of Shortest Job First Algorithm
{
...
void shortestRemainingTime() ////Pre Emptive Version of Shortest Job First Algorithm,
{
...
// HRRN Scheduling: Prioritizes processes based on their response ratio, which includes both waiting time
// and service time. Processes with higher ratios (indicating longer wait times relative to service time)
// are given higher priority to run next.
...
void aging(int originalQuantum) ///// Prioiryt Scheduling Based on Just the Aging of the Process
